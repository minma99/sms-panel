...
<input type="date" name="start_date_gregorian"
value="{{ old('start_date_gregorian',$course->start_date_gregorian) }}"
class="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring focus:border-blue-300">
...
<input type="date" name="end_date_gregorian"
value="{{ old('end_date_gregorian',$course->end_date_gregorian) }}"
class="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring focus:border-blue-300">
...
<input type="text" name="start_date_shamsi"
value="{{ old('start_date_shamsi',$course->start_date_shamsi) }}"
class="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring focus:border-blue-300">
</div>
...
<input type="text" name="end_date_shamsi"
value="{{ old('end_date_shamsi',$course->end_date_shamsi) }}"
class="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring focus:border-blue-300">
</div>
